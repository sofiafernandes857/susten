    ...
    return (
        <div>
            ...
            <div id="threejs-controls3d">
                ...
                <button id="changeModelButton" className="threejs-control-button3d">Mudar Modelo</button>
                <button onClick={() => setShowColorPicker(!showColorPicker)} className="threejs-control-button3d">Mudar Cor</button>
                {showColorPicker && (
                    <input
                        type="color"
                        value={currentColor}
